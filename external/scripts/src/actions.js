...
hostReactAppReady().then(() => {
    const svgIcon = `
        <svg style="margin-right: 6px;" xmlns="http://www.w3.org/2000/svg" width="26" height="16" viewBox="0 0 26 16" fill="none">
    ...
    function handleMobile() {
        const observer = new MutationObserver((mutations) => {
            ...
            if (burgerLink && !burgerLink.querySelector('svg')) {
                burgerLink.insertAdjacentHTML('afterbegin', svgIcon);
            }
        });
