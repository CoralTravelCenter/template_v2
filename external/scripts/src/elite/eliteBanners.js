(() => {
    ...
    let bannerViewMetricSent = false;
    ...
    function initBannerAnalytics(root) {
        ...
        if (!bannerViewMetricSent && typeof window.ym === 'function' && cards.length) {
            window.ym(96674199, 'reachGoal', 'personalization_elite_view_promotion');
            bannerViewMetricSent = true;
        }
